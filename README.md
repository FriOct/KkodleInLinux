...
- 주의사항 : <pre>❌처음 실행시 화면이 깨질때 Ctrl+C 후 다시 실행❌
                ❌화면이 나오지 않을 시 창 크기를 크게 조걸❌</pre>
<br>
